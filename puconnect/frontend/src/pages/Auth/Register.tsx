                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    type="text"
                                    required
                                    className={`appearance-none block w-full px-3 py-2 border ${errors.universityId ? 'border-red-300' : 'border-gray-300'
                                        } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-150 ease-in-out`}
                                    placeholder="PU123456"
                                    value={universityId}
                                    onChange={(e) => {
                                        setUniversityId(e.target.value);
                                        if (errors.universityId) setErrors({ ...errors, universityId: undefined });
                                    }}
                                />
                                {errors.universityId && (
                                    <p className="mt-1 text-xs text-red-600">{errors.universityId}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                                Must be at least 8 characters with explicit uppercase, lowercase, and number.
                            </p>
                        </div>
                    </div>
