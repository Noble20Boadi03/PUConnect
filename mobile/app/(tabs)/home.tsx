...
const SectionHeader = React.memo(({ title, onSeeAll, horizontalPadding }: SectionHeaderProps) => {
  return (
...
export default function HomeScreen() {
  ...
  const handleSubcategoryPress = useCallback((title: string, categoryId: string) => {
    router.push({ 
    ...
    <ScreenLayout padding="none" withSafeArea={false}>
      ...
      >
        ...
        <ThemedText variant="bodySmall" colorName="textMuted" style={[styles.discoveryTip, horizontalPadding]}>
          {activeFilter === 'All'
            ? 'Tip: Browse Services for professional help or Requests to find students who need your skills.'
            : activeFilter === 'Services'
            ? 'Tip: Services are students offering professional help. Hire them to get your tasks done.'
            : 'Tip: Requests are from students who need help. Apply to these to earn and build your portfolio.'}
        </ThemedText>
      </ThemedView>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <PopularCategoryCard
                  ...
                  onPress={() => handleSubcategoryPress(item.title, item.categoryId)}
                />
              )}
