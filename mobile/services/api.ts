...
const MOCK_LISTINGS: Listing[] = [
    {
        ...
        type: 'service_offer',
        ownerId: 'user-002',
        media_urls: ['https://images.unsplash.com/photo-1626785774573-4b799315345d?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_offer',
        ownerId: 'user-003',
        media_urls: ['https://images.unsplash.com/photo-1509228468518-180dd4864904?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_offer',
        ownerId: 'user-004',
        media_urls: ['https://images.unsplash.com/photo-1526498460520-4c246339dccb?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_offer',
        ownerId: 'user-005',
        media_urls: ['https://images.unsplash.com/photo-1526367790999-015078648402?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_offer',
        ownerId: 'user-006',
        media_urls: ['https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_request',
        ownerId: 'user-009',
        media_urls: ['https://images.unsplash.com/photo-1510915361894-db8b60106cb1?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_request',
        ownerId: 'user-007',
        media_urls: ['https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_offer',
        ownerId: 'user-004',
        media_urls: ['https://images.unsplash.com/photo-1572044162444-ad60f128bde2?w=800&auto=format&fit=crop'],
        isActive: true,
    ...
    },
    {
        ...
        type: 'service_offer',
        ownerId: 'user-006',
        media_urls: ['https://images.unsplash.com/photo-1614850523296-d8c1af93d400?w=800&auto=format&fit=crop'],
        isActive: true,
...
const MOCK_TALENT: User[] = [
    { ...MOCK_USER, id: 'talent-001', fullName: 'Ama Mensah', username: 'amensah', department: 'Graphic Design', skillTags: ['Illustration', 'Branding', 'Figma'], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { ...MOCK_USER, id: 'talent-002', fullName: 'Kwame Asante', username: 'kasante', department: 'Engineering', skillTags: ['Python', 'Machine Learning', 'Data Science'], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { ...MOCK_USER, id: 'talent-003', fullName: 'Nana Yaa', username: 'nyaa', department: 'Business', skillTags: ['Marketing', 'Social Media', 'Copywriting'], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
];

/** Synthetic campus users backing listing `ownerId`s (public profiles + chat headers). */
const MOCK_PEER_USERS: Record<string, User> = {
    'user-002': { ...MOCK_USER, id: 'user-002', fullName: 'Alex Rivera', username: 'arivera', email: 'arivera@university.edu', universityId: '2024002', department: 'Graphic Design', graduationYear: 2026, skillTags: ['Logo Design', 'Branding', 'Figma'], bio: 'Design lead for campus clubs and startups.', canOfferServices: true, profilePictureUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop' },
    'user-003': { ...MOCK_USER, id: 'user-003', fullName: 'Jordan Kim', username: 'jkim', email: 'jkim@university.edu', universityId: '2024003', department: 'Physics', graduationYear: 2025, skillTags: ['STEM Tutoring', 'Calculus'], bio: 'Peer tutor for math and physics courses.', canOfferServices: true, profilePictureUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop' },
    'user-004': { ...MOCK_USER, id: 'user-004', fullName: 'Sam Okoro', username: 'sokoro', email: 'sokoro@university.edu', universityId: '2024004', department: 'Computer Science', graduationYear: 2026, skillTags: ['React Native', 'Expo', 'TypeScript'], bio: 'Mobile and full-stack projects for student orgs.', canOfferServices: true, profilePictureUrl: 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?w=200&h=200&fit=crop' },
    'user-005': { ...MOCK_USER, id: 'user-005', fullName: 'Riley Chen', username: 'rchen', email: 'rchen@university.edu', universityId: '2024005', department: 'Business', graduationYear: 2027, skillTags: ['Delivery', 'Logistics'], bio: 'Fast campus delivery and errands.', canOfferServices: true, profilePictureUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop' },
    'user-006': { ...MOCK_USER, id: 'user-006', fullName: 'Morgan Blake', username: 'mblake', email: 'mblake@university.edu', universityId: '2024006', department: 'Film', graduationYear: 2025, skillTags: ['Photography', 'Video'], bio: 'Events, portraits, and short-form content.', canOfferServices: true, profilePictureUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&h=200&fit=crop' },
    'user-007': { ...MOCK_USER, id: 'user-007', fullName: 'Casey Lee', username: 'clee', email: 'clee@university.edu', universityId: '2024007', department: 'English', graduationYear: 2026, skillTags: ['Writing', 'Career'], bio: 'Resume reviews and writing help.', canOfferServices: true },
    'user-008': { ...MOCK_USER, id: 'user-008', fullName: 'Taylor Brooks', username: 'tbrooks', email: 'tbrooks@university.edu', universityId: '2024008', department: 'Marketing', graduationYear: 2027, skillTags: ['Social Media', 'Growth'], bio: 'Campus campaigns and brand strategy.', canOfferServices: true },
    'user-009': { ...MOCK_USER, id: 'user-009', fullName: 'Jamie Fox', username: 'jfox', email: 'jfox@university.edu', universityId: '2024009', department: 'Music', graduationYear: 2025, skillTags: ['Production', 'Mixing'], bio: 'Beats and studio sessions.', canOfferServices: true },
    'user-010': { ...MOCK_USER, id: 'user-010', fullName: 'Riley Nguyen', username: 'rnguyen', email: 'rnguyen@university.edu', universityId: '2024010', department: 'Hospitality', graduationYear: 2026, skillTags: ['Events', 'Planning'], bio: 'Student org events and logistics.', canOfferServices: true },
    'user-011': { ...MOCK_USER, id: 'user-011', fullName: 'Quinn Patel', username: 'qpatel', email: 'qpatel@university.edu', universityId: '2024011', department: 'Linguistics', graduationYear: 2027, skillTags: ['Translation', 'Editing'], bio: 'Multilingual editing and translation.', canOfferServices: true },
};
