  ...
  if (!post) {
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-4">
        ...
        <button onClick={() => navigate('/content')} className="text-purple-600 hover:text-purple-800 font-medium">
          Back to Content
        </button>
      </div>
    );
        ...
        {isEditing ? (
          <div className="space-y-4">
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 text-xl font-semibold"
            />
            <textarea
